...
public class GUIDraggableObject
{
	...
	public bool Click(Rect clickRect, int buttonId = 0)
	{
		return (Event.current.type == EventType.MouseDown && Event.current.button == buttonId && clickRect.Contains (Event.current.mousePosition));
	}
